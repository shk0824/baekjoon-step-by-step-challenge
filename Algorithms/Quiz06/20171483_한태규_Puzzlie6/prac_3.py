...
def findFakeGroupAndType(group1, group2, group3):
    ...
    if group1_sum == group2_sum:
        if group1_sum < group3_sum:
            another_number = group3_sum - group1_sum ## prac_3 추가
        else:
            another_number = group1_sum - group3_sum ## prac_3 추가

    elif group1_sum == group3_sum:
        if group1_sum < group2_sum:
            another_number = group2_sum - group1_sum ## prac_3 추가
        else:
            another_number = group1_sum - group2_sum ## prac_3 추가

    elif group2_sum == group3_sum: 
        if group1_sum < group3_sum:
            another_number = group3_sum - group1_sum ## prac_3 추가
        else:
            another_number = group1_sum - group3_sum ## prac_3 추가
